...
#The dispatch module determines the system-wide cost-optimal dispatch by minimizing the sum of variable costs for all technologies while satisfying hourly electricity demand constraints over the six representative days obtained from the electricity demand module.
